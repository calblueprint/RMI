...
NUM_BIG_BOX = 5
NUM_DROP_DOWN = 5
NUM_DD_FEW_OPTIONS = NUM_DROP_DOWN/2.to_i
NUM_DD_LOTS_OPTIONS = NUM_DROP_DOWN - NUM_DD_FEW_OPTIONS
NUM_RANGE = 5
NUM_R_FEW_OPTIONS = NUM_RANGE/2.to_i
NUM_FREE_QUESTIONS = 5
NUM_DEPENDENT_QUESTIONS = 5
...
def make_questions_options
  1.upto(NUM_BIG_BOX) do |n|
    building_type = BuildingType.find(n)
    1.upto(NUM_DROP_DOWN) do |n|
      question = building_type.question.create(
